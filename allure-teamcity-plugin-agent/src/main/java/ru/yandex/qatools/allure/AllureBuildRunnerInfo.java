...
import static ru.yandex.qatools.allure.AllureBuildServiceAdapter.TOOL_NAME;
...
public class AllureBuildRunnerInfo implements AgentBuildRunnerInfo {
    ...
    public boolean canRun(@NotNull BuildAgentConfiguration agentConfiguration) {
        boolean canRun = new File(agentConfiguration.getAgentToolsDirectory(), TOOL_NAME).exists();
        if (!canRun) {
